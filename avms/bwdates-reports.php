...
<body class="animsition">
    ...
    echo $msg;
                                        ...
                                        <p style="text-align: center;"><button type="submit" name="submit" id="submit" class="btn btn-primary btn-sm"style="background-color:#CC6699; border-color:#660033">Submit
                                        </button></p>
